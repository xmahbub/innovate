    ...
    return(
      <div className='flex-row justify-center justify-self-center px-14 lg:justify-between pt-20 lg:flex'>
          ...
          <div className='flex-col about sm:justify-center'>
              <div className='main-text'><h1 className='text-4xl lg:text-7xl text-iec-font-primery font-iec-font-family'><span className='text-iec-font-color logo'>Consultancy</span> and <span className='text-iec-font-color logo'>Designing</span> firm that was established in January <span className='text-iec-font-color logo'>2012.</span></h1></div>
